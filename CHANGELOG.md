...
### Fixed
- Fixed DoS vulnerabilities in `moqt/internal/message` where overly large byte array sizes or string array counts could cause `panic` or Out-of-Memory (OOM) via excessive memory allocations.
