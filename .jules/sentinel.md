...
## YYYY-MM-DD - [DoS via panic on oversized varint]
**Vulnerability:** Calling panic() in network payload parsers (ReadBytes, ReadStringArray) when lengths exceed architecture bounds.
...
**Prevention:** Always fail securely by returning appropriate errors (e.g., errors.New("byte slice too large")) instead of panicking.
