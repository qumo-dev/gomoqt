...
To bypass URL handling entirely — dialing an address you have already resolved,
or supplying your own handshake — set `DialQUICFunc` or `DialWebTransportFunc`
on the `Dialer` — see the **Using Custom QUIC** tab under
[Initialize a Dialer](#initialize-a-dialer).
