...
[MSF Catalog](/msf/overview#catalog) can be helpful as a way to discover and negotiate track names within a broadcast.
...
<Columns cols={2}>
	<Card title="Consume a Track" icon="download" href="/moq/consume_track">How to consume a track.</Card>
</Columns>
