...
This implementation is based on [Media over QUIC - Lite Draft 05](https://www.ietf.org/archive/id/draft-lcurley-moq-lite-05.html). For detailed specification compliance status and implementation differences, see [SPECIFICATION.md](../SPECIFICATION.md) in the root directory.

## Installation

```go
import "github.com/qumo-dev/gomoqt/moqt"
```
